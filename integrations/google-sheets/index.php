     ...
     <a id="whatsapp-enquiry"
      ...
      <div class="col-lg-6">
        <div class="api-image-box " style="padding: 20px; border-radius: 10px;">
          <img width="100%" src="/assets/images/hellobots/integrations-google-sheets/WhatsApp-Google-Sheets-Integration.png" loading="lazy"
    ...
    <div class="swiper partners-slider">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="/assets/images/hellobots/integrations-google-sheets/Footer_Logo.png" alt="Looks Salon">
        </div>
        <div class="swiper-slide">
          <img src="/assets/images/hellobots/integrations-google-sheets/Mahindra-Logo-2000.png" alt="Mahindra">
        </div>
        <div class="swiper-slide">
          <img src="/assets/images/hellobots/integrations-google-sheets/SkodaLogoNew.png" alt="Skoda">
        </div>
        <div class="swiper-slide">
          <img src="/assets/images/hellobots/integrations-google-sheets/Vegtration_Logo.png" alt="Vegetarian Brand">
        </div>
        <div class="swiper-slide">
          <img src="/assets/images/hellobots/integrations-google-sheets/zee-business.png" alt="Zee Business">
        </div>
      </div>
...
<section class="integrations-section">
    ...
    <div class="marquee-wrapper">
      ...
      <div class="integration-card" data-key="shopify">
          <img src="/assets/images/hellobots/integrations-google-sheets/shopify.png" class="int-icon-box" alt="Shopify">
          <span class="int-name">Shopify</span>
        </div>
        
        <div class="integration-card">
          <img src="/assets/images/hellobots/integrations-google-sheets/woocommerce.png" class="int-icon-box" alt="WooCommerce">
          <span class="int-name">WooCommerce</span>
        </div>
        <div class="integration-card">
          <img src="/assets/images/hellobots/integrations-google-sheets/gotab.png" class="int-icon-box" alt="Gotab">
          <span class="int-name">Gotab</span>
        </div>
     
            <div class="integration-card" data-key="wortal">
          <img loading="lazy" src="/assets/images/hellobots/integrations-google-sheets/wortal.png" class="int-icon-box" width="50" height="50" loading="lazy" alt="Wortal">
          <span class="int-name">Wortal</span>
        </div>
        
       <div class="integration-card" data-key="shiprocket">
          <img loading="lazy" src="/assets/images/hellobots/integrations-google-sheets/shiprocket.png" class="int-icon-box" width="50" height="50" loading="lazy" alt="shiprocket.com">
          <span class="int-name">Shiprocket</span>
        </div>
        <div class="integration-card" data-key="zoho">
          <img loading="lazy" src="/assets/images/hellobots/integrations-google-sheets/zoho.png" class="int-icon-box" width="50" height="50" loading="lazy" alt="zoho">
          <span class="int-name">Zoho</span>
        </div>
        
        <div class="integration-card" data-key="google-sheets">
          <img loading="lazy" src="/assets/images/hellobots/integrations-google-sheets/google-sheet.png" class="int-icon-box" width="50" height="50" loading="lazy" alt="googlesheet">
          <span class="int-name">Google Sheet</span>
        </div>
    
        <div class="integration-card">
          <img loading="lazy" src="/assets/images/hellobots/integrations-google-sheets/n8n.png" class="int-icon-box" width="50" height="50" loading="lazy" alt="n8n">
        ...
        <div class="integration-card">
          <img loading="lazy" src="/assets/images/hellobots/integrations-google-sheets/woocommerce.png" class="int-icon-box" width="50" height="50" loading="lazy" alt="WooCommerce">
          <span class="int-name">WooCommerce</span>
        </div>
        <div class="integration-card">
          <img loading="lazy" src="/assets/images/hellobots/integrations-google-sheets/gotab.png" class="int-icon-box" width="50" height="50" loading="lazy" alt="Gotab">
          <span class="int-name">Gotab</span>
        </div>
