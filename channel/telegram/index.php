...
<style>
  ...
  .ctg-btn-primary {
    ...
    box-shadow: 0 6px 18px -3px rgba(2, 132, 199, 0.38) !important;
  ...
  .ctg-btn-primary:hover {
    ...
    box-shadow: 0 10px 24px -3px rgba(2, 132, 199, 0.5) !important;
    color: #ffffff !important;
  }
  .ctg-btn-secondary {
    display: inline-flex !important;
  ...
  .ctg-hero-actions .btn-download-data {
  ...
  .ctg-hero-actions .btn-download-data:hover {
    background: linear-gradient(135deg, #4338CA 0%, #6D28D9 100%) !important;
    transform: translateY(-2px) !important;
    box-shadow: 0 10px 24px -3px rgba(79, 70, 229, 0.58) !important;
    color: #ffffff !important;
  }
  .ctg-hero-actions .btn-download-data svg {
    width: 16px !important;
    height: 16px !important;
    flex-shrink: 0 !important;
    transition: transform 0.2s ease !important;
  }
  .ctg-hero-actions .btn-download-data:hover svg {
  ...
  <section class="ctg-sales-section">
    <div class="ctg-cta-banner">
      ...
      <div class="ctg-cta-actions">
        ...
        <a href="<?php echo $bp; ?>business-leads/" class="btn-download-data btn-get-verified" style="background:#ffffff !important;color:#0284c7 !important;border:none !important;">
          <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><polyline points="9 12 11 14 15 10"/></svg>
          Get Verified
        </a>
      </div>
