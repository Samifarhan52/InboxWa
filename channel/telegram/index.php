...
<style>
  ...
  @media (max-width: 1024px) {
    .ctg-hero-grid { grid-template-columns: 1fr; gap: 3rem; }
    .ctg-features-grid { grid-template-columns: repeat(2, 1fr); }
    .ctg-steps-grid { grid-template-columns: repeat(2, 1fr); }
  }
  @media (max-width: 640px) {
    .ctg-features-grid { grid-template-columns: 1fr; }
    .ctg-steps-grid { grid-template-columns: 1fr; }
  }
</style>
