    ...
    <div class="cig-hero-grid">
      <div class="cig-hero-content">
        ...
        <div class="cig-hero-actions">
          ...
          <button type="button" class="cig-btn-secondary btn-demo-open" style="background:transparent;cursor:pointer;">
            Book Instagram Demo
          </button>
  ...
  <section class="cig-cta-banner">
    <div class="cig-container" style="position: relative; z-index: 2;">
      ...
      <div class="cig-cta-actions">
        ...
        <a href="https://panindiadata.com/" target="_blank" rel="noopener noreferrer" class="btn-download-data" style="background:#ffffff !important;color:#ec4899 !important;border:none !important;">
          <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
          Download Data
        </a>
      </div>
