  ...
  <section class="cig-cta-banner">
    <div class="cig-container" style="position: relative; z-index: 2;">
      ...
      <div class="cig-cta-actions">
        ...
        <a href="<?php echo $bp; ?>business-leads/" class="btn-download-data btn-get-verified" style="background:#ffffff !important;color:#ec4899 !important;border:none !important;">
          <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><polyline points="9 12 11 14 15 10"/></svg>
          Get Verified
        </a>
      </div>
