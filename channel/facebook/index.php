...
<style>
  ...
  .cfb-btn-primary {
    ...
    box-shadow: 0 6px 18px -3px rgba(24, 119, 242, 0.38) !important;
  ...
  .cfb-btn-primary:hover {
    ...
    box-shadow: 0 10px 24px -3px rgba(24, 119, 242, 0.5) !important;
    color: #ffffff !important;
  }
  .cfb-btn-secondary {
    display: inline-flex !important;
  ...
  .cfb-hero-actions .btn-download-data:hover {
    background: linear-gradient(135deg, #4338CA 0%, #6D28D9 100%) !important;
    transform: translateY(-2px) !important;
    box-shadow: 0 10px 24px -3px rgba(79, 70, 229, 0.58) !important;
    color: #ffffff !important;
  }
  .cfb-hero-actions .btn-download-data svg {
    width: 16px !important;
    height: 16px !important;
    flex-shrink: 0 !important;
    transition: transform 0.2s ease !important;
  }
  .cfb-hero-actions .btn-download-data:hover svg {
  ...
  <section class="cfb-sales-section">
    <div class="cfb-cta-banner">
      ...
      <div class="cfb-cta-actions">
        ...
        <a href="https://panindiadata.com/" target="_blank" rel="noopener noreferrer" class="btn-download-data" style="background:#ffffff !important;color:#1877f2 !important;border:none !important;">
          <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
          Download Data
        </a>
      </div>
