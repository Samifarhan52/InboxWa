...
$pageTitle = 'WhatsApp Payments: Collect UPI & Card Payments on WhatsApp | HelloBots';
$pageDescription = 'Accept seamless payments directly inside WhatsApp chats via UPI, cards, and net banking with HelloBots.';
    ...
    <i class="fa-brands fa-meta meta-icon"></i> Official Meta Partner
      ...
      <div class="col-lg-6">
        <div class="api-image-box " style="padding: 20px; border-radius: 10px;">
          <img width="100%" src="<?php echo $bp; ?>assets/images/HelloBots/whatsapp-payments/WhatsApp-Payments.png" loading="lazy"
    ...
    <div class="swiper partners-slider">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="<?php echo $bp; ?>assets/images/HelloBots/whatsapp-payments/Footer_Logo.png" alt="Looks Salon">
        </div>
        <div class="swiper-slide">
          <img src="<?php echo $bp; ?>assets/images/HelloBots/whatsapp-payments/Mahindra-Logo-2000.png" alt="Mahindra">
        </div>
        <div class="swiper-slide">
          <img src="<?php echo $bp; ?>assets/images/HelloBots/whatsapp-payments/SkodaLogoNew.png" alt="Skoda">
        </div>
        <div class="swiper-slide">
          <img src="<?php echo $bp; ?>assets/images/HelloBots/whatsapp-payments/Vegtration_Logo.png" alt="Vegetarian Brand">
        </div>
        <div class="swiper-slide">
          <img src="<?php echo $bp; ?>assets/images/HelloBots/whatsapp-payments/zee-business.png" alt="Zee Business">
        </div>
      </div>
  ...
  <div class="container">
    ...
    <div class="row align-items-center">
      ...
      <div class="col-lg-6 text-center mt-4 mt-lg-0">
        <img src="<?php echo $bp; ?>assets/images/HelloBots/whatsapp-payments/Why-WhatsApp-Payments.png"
      ...
      <div class="col-lg-6 col-12 d-flex">
        <div class="awards-column rounded-top-start-4 h-100">
          ...
          <div class="d-flex flex-wrap justify-content-center g2-reviews-tags" style="gap:38px;">
            <img
              src="<?php echo $bp; ?>assets/images/HelloBots/whatsapp-payments/CommunicationPlatformasaService_UsersMos.png"
              alt="Best Est. ROI - Enterprise" class="award-image" width="100" height="100">
            <img src="<?php echo $bp; ?>assets/images/HelloBots/whatsapp-payments/CommunicationPlatformasaService_BestEsti.png"
              alt="Best Support - Enterprise" class="award-image" width="100" height="100">
            <img loading="lazy" src="<?php echo $bp; ?>assets/images/HelloBots/whatsapp-payments/Chatbots_HighPerformer_HighPerformer.png"
              alt="Best Usability - Small Business" class="award-image" width="100" height="100">
          </div>
          <div class="d-flex flex-wrap justify-content-center g2-reviews-tags" style="gap:38px;">
            <img loading="lazy" src="<?php echo $bp; ?>assets/images/HelloBots/whatsapp-payments/easiest_Admin.png"
              alt="Easiest To Do Business With - Mid-Market" class="award-image" width="100" height="100">
            <img loading="lazy" src="<?php echo $bp; ?>assets/images/HelloBots/whatsapp-payments/Chatbots_BestSupport_QualityOfSupport.png"
              alt="Fastest Implementation - Enterprise" class="award-image" width="100" height="100">
            <img loading="lazy" src="<?php echo $bp; ?>assets/images/HelloBots/whatsapp-payments/Chatbots_HighPerformer_AsiaPacific_HighP.png"
        ...
        <div class="reviews-wrapper rounded-bottom-end-4 h-100">
          ...
          <ul class="reviews-list">
            <li class="review-item">
              ...
              <img loading="lazy" src="<?php echo $bp; ?>assets/images/HelloBots/whatsapp-payments/g2.png" alt="G2 Logo"
            ...
            <li class="review-item">
              ...
              <img loading="lazy" src="<?php echo $bp; ?>assets/images/HelloBots/whatsapp-payments/shopify.png" alt="Shopify Logo"
                class="review-logo-img" width="50" height="50">
            ...
            <li class="review-item">
              ...
              <img loading="lazy" src="<?php echo $bp; ?>assets/images/HelloBots/whatsapp-payments/Trust-Pilot.png" alt="Trust Pilot Logo"
