  ...
  <div class="container">
    ...
    justify-content: center; gap:20px;">
                      <!-- Enquiry Now Button -->
                         ...
                         <a href="<?php echo $bp; ?>auth/register" target="_blank" rel="noopener noreferrer" style="text-decoration: none; color: white;"class="btn-apply cta-button cta-buttonn">Get Started</a> 
