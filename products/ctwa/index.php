...
<section class="how-it-works">
  <div class="container">
    <h2>How to Setup and Run Click to WhatsApp Ads</h2>
    ...
    <div class="steps-wrapper">
      <div class="step-card">
        ...
        <p>
          Set up your account using the WhatsApp Business app or WhatsApp Business API to get started.
        </p>
      </div>
      ...
      <div class="step-card">
        ...
        <p>
          Create an eye-catching ad with a clear “Send Message” CTA on platforms like Facebook or Instagram.
        </p>
      </div>
      ...
      <div class="step-card">
        ...
        <p>
          Define and reach your ideal audience using smart targeting tools to maximize engagement.
        </p>
      </div>
      ...
      <div class="step-card">
        ...
        <h3>Initiate Chat</h3>
        <p>
          The CTA instantly opens WhatsApp, connecting users with your business for real-time conversations.
        </p>
      </div>
    </div>
  </div>
