    ...
    <div class="row">
      ...
      <div class="col-12">
        <p class="text-center">
          ...
          business name in WhatsApp. It's a Key feature of <a href="https://HelloBots.com/whatsapp-business-api/" target="_blank" rel="noopener noreferrer">WhatsApp API</a>, and assures the customers that they’re engaging with a verified business and
          not an impostor.
      </div>
    </div>
  </div>
      ...
      <div class="col-lg-6 order-1 order-lg-2">
        <div class="step">
          ...
          <div class="step-text">
            ...
            <p>Create or login HelloBots account and <a href="https://HelloBots.com/whatsapp-business-api/" target="_blank" rel="noopener noreferrer">get a WhatsApp Business API account</a>. An approved WhatsApp number is necessary to get a verified badge.
            </p>
          </div>
        </div>
    ...
    elements.nextBtn?.addEventListener('click', () => {
        if (modalState.currentStep === 1) {
            ...
            if (validateStep2()) {
                ...
                fetch('https://app.HelloBots.com/bluetick/submit', {
                    method: 'POST',
                    headers: {
...
window.contactSelectOptPromise = new Promise((resolve, reject) => {
    ...
    const ajaxURL = "https://HelloBots.com/wp-admin/admin-ajax.php";
