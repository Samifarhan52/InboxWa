(function(){
  var codes = {
    curl: 'curl -X POST "https://api.hellobotz.com/v1/messages" \\\n  -H "Authorization: Bearer inb_live_sec_918050854445" \\\n  -H "Content-Type: application/json" \\\n  -d \'{\n    "messaging_product": "whatsapp",\n    "recipient_type": "individual",\n    "to": "+918050854445",\n    "type": "template",\n    "template": {\n      "name": "order_confirmation",\n      "language": { "code": "en_US" },\n      "components": [\n        {\n          "type": "body",\n          "parameters": [\n            { "type": "text", "text": "Aanya Kapoor" },\n            { "type": "text", "text": "ORD-84920" },\n            { "type": "text", "text": "₹2,499" }\n          ]\n        }\n      ]\n    }\n  }\'',

    js: 'const axios = require(\'axios\');\n\nasync function sendWhatsAppNotification() {\n  try {\n    const response = await axios.post(\n      \'https://api.hellobotz.com/v1/messages\',\n      {\n        messaging_product: \'whatsapp\',\n        recipient_type: \'individual\',\n        to: \'+918050854445\',\n        type: \'template\',\n        template: {\n          name: \'order_confirmation\',\n          language: { code: \'en_US\' },\n          components: [\n            {\n              type: \'body\',\n              parameters: [\n                { type: \'text\', text: \'Aanya Kapoor\' },\n                { type: \'text\', text: \'ORD-84920\' },\n                { type: \'text\', text: \'₹2,499\' }\n              ]\n            }\n          ]\n        }\n      },\n      {\n        headers: {\n          \'Authorization\': `Bearer ${process.env.HELLOBOTZ_API_KEY || \'inb_live_sec_918050854445\'}`,\n          \'Content-Type\': \'application/json\'\n        }\n      }\n    );\n\n    console.log(\'Message dispatched ID:\', response.data.messages[0].id);\n    return response.data;\n  } catch (err) {\n    console.error(\'HelloBotz API Error:\', err.response?.data || err.message);\n  }\n}\n\nsendWhatsAppNotification();',

    py: 'import os\nimport requests\n\nAPI_URL = "https://api.hellobotz.com/v1/messages"\nAPI_KEY = os.getenv("HELLOBOTZ_API_KEY", "inb_live_sec_918050854445")\n\nheaders = {\n    "Authorization": f"Bearer {API_KEY}",\n    "Content-Type": "application/json"\n}\n\npayload = {\n    "messaging_product": "whatsapp",\n    "recipient_type": "individual",\n    "to": "+918050854445",\n    "type": "template",\n    "template": {\n        "name": "order_confirmation",\n        "language": {"code": "en_US"},\n        "components": [\n            {\n                "type": "body",\n                "parameters": [\n                    {"type": "text", "text": "Aanya Kapoor"},\n                    {"type": "text", "text": "ORD-84920"},\n                    {"type": "text", "text": "₹2,499"}\n                ]\n            }\n        ]\n    }\n}\n\nresponse = requests.post(API_URL, headers=headers, json=payload)\nprint(f"HTTP Status: {response.status_code}")\nprint("Response Payload:", response.json())',

    php: '<?php\n$apiKey = getenv(\'HELLOBOTZ_API_KEY\') ?: \'inb_live_sec_918050854445\';\n$apiUrl = \'https://api.hellobotz.com/v1/messages\';\n\n$payload = [\n    \'messaging_product\' => \'whatsapp\',\n    \'recipient_type\' => \'individual\',\n    \'to\' => \'+918050854445\',\n    \'type\' => \'template\',\n    \'template\' => [\n        \'name\' => \'order_confirmation\',\n        \'language\' => [\'code\' => \'en_US\'],\n        \'components\' => [\n            [\n                \'type\' => \'body\',\n                \'parameters\' => [\n                    [\'type\' => \'text\', \'text\' => \'Aanya Kapoor\'],\n                    [\'type\' => \'text\', \'text\' => \'ORD-84920\'],\n                    [\'type\' => \'text\', \'text\' => \'₹2,499\']\n                ]\n            ]\n        ]\n    ]\n];\n\n$ch = curl_init($apiUrl);\ncurl_setopt_array($ch, [\n    CURLOPT_POST => true,\n    CURLOPT_RETURNTRANSFER => true,\n    CURLOPT_HTTPHEADER => [\n        \'Authorization: Bearer \' . $apiKey,\n        \'Content-Type: application/json\'\n    ],\n    CURLOPT_POSTFIELDS => json_encode($payload)\n]);\n\n$response = curl_exec($ch);\n$httpCode = curl_getinfo($ch, CURLINFO_HTTP_CODE);\ncurl_close($ch);\n\necho "HTTP Status: " . $httpCode . "\\n";\necho "Response: " . $response . "\\n";'
  };
  ...
  if (btn && out) {
    var logs = [
      '⚡ [00ms] Initializing TLS 1.3 connection to api.hellobotz.com:443...',
  ...
  if (run && rout) {
    run.addEventListener('click', function(){
      ...
      rout.textContent = '🚀 Webhook Event Dispatched:\n' +
        'HEADER: X-HelloBotz-Event: ' + trVal.toLowerCase().replace(/[^a-z0-9]/g, '.') + '\n' +
        'HEADER: X-HelloBotz-Signature: sha256=' + Array.from({length: 32}, () => Math.floor(Math.random()*16).toString(16)).join('') + '\n' +
