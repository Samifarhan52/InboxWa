...
<div class="industry-page">
      ...
      <div class="industry-hero-grid">
        <div class="industry-hero-content">
          ...
          <div class="industry-ctas">
            ...
            <a href="https://panindiadata.com/" target="_blank" rel="noopener noreferrer" class="btn-download-data" style="padding:0.8rem 1.5rem;">
  ...
  <?php if ($currentSlug === 'education-and-social-impacts'): ?>
  <!-- =========================================================================
       2.1 5-STAGE INTERACTIVE LIFECYCLE TOUR (ONE CONNECTED ENROLLMENT SYSTEM)
       ========================================================================= -->
  <section class="stages-native" id="enrollment-system">
    ...
    <div class="container">
      <div class="industry-cta-banner">
        ...
        <div class="industry-cta-actions">
          ...
          <a href="https://panindiadata.com/" target="_blank" rel="noopener noreferrer" class="btn-download-data" style="background:#ffffff !important;color:#4f46e5 !important;border:none !important;box-shadow:0 6px 20px rgba(0,0,0,0.15) !important;">
            <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
            Download Data
          </a>
...
// 5-Stage Interactive Lifecycle Tour Tabs Switcher
