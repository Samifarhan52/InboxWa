...
?>
  ...
  /* =========================================================
     ...
     Unique, high-tech, responsive ambient background & glassmorphism
     ========================================================= */
  .footer-contact-section {
    position: relative;
    overflow: hidden;
    padding: 5.5rem 0 6rem;
    background: linear-gradient(180deg, #F8FAFC 0%, #EEF2F6 40%, #E2E8F0 100%);
  ...
  .contact-bg-orb-emerald {
    ...
    width: 520px;
    height: 520px;
    background: radial-gradient(circle, rgba(16, 185, 129, 0.28) 0%, rgba(5, 150, 105, 0.12) 50%, transparent 75%);
  ...
  .contact-bg-orb-indigo {
    ...
    width: 560px;
    height: 560px;
    background: radial-gradient(circle, rgba(99, 102, 241, 0.26) 0%, rgba(139, 92, 246, 0.12) 50%, transparent 75%);
  ...
  .contact-float-chip {
    ...
    box-shadow: 0 12px 28px -6px rgba(15, 23, 42, 0.08), 0 0 0 1px rgba(99, 102, 241, 0.06);
  ...
  .contact-glass-card {
    ...
    border-radius: 24px;
    padding: 2.5rem;
    box-shadow: 0 20px 45px -15px rgba(15, 23, 42, 0.08), 0 0 0 1px rgba(99, 102, 241, 0.08);
    position: relative;
    overflow: hidden;
    display: flex;
  ...
  .contact-glass-card:hover {
    box-shadow: 0 26px 55px -16px rgba(15, 23, 42, 0.12), 0 0 0 1px rgba(99, 102, 241, 0.15);
  }
  ...
  /* Modern Glassmorphic Form Styling */
  .footer-contact-form {
    display: flex;
    flex-direction: column;
    gap: 1.15rem;
  ...
  .contact-glass-card .form-input:focus {
    ...
    box-shadow: 0 0 0 4px rgba(99, 102, 241, 0.16), 0 2px 8px rgba(99, 102, 241, 0.08) !important;
  }
  ...
  .btn-contact-submit {
    ...
    border: none;
    cursor: pointer;
    box-shadow: 0 8px 24px -4px rgba(16, 185, 129, 0.42);
    transition: all 0.25s cubic-bezier(0.16, 1, 0.3, 1);
  }
  .btn-contact-submit:hover {
    transform: translateY(-2px);
    box-shadow: 0 12px 28px -4px rgba(16, 185, 129, 0.52);
          ...
          <div>
            ...
            <form class="footer-contact-form" action="javascript:void(0)" method="post" id="footer-contact-form" novalidate>
              ...
              <div class="contact-field-group">
                ...
                <textarea class="form-input" id="fc-message" name="message" rows="3" required placeholder="Tell us about your team size, expected monthly message volume, or specific use cases..."></textarea>
              </div>
