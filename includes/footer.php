...
?>
  ...
  .footer-map-header-info {
    display: flex;
    align-items: center;
    gap: 0.75rem;
  }
  .footer-map-header-icon {
    width: 36px;
    height: 36px;
    border-radius: 10px;
    ...
    <div class="container">
      ...
      <div class="footer-map-card">
        <div class="footer-map-header">
          <div class="footer-map-header-info">
            <div class="footer-map-header-icon">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg>
            </div>
            <div>
              <h3 class="footer-map-title">HelloBotz Head Office — Bengaluru</h3>
              <p class="footer-map-addr">Shanthala Nagar, Ashok Nagar, Bengaluru, Karnataka 560025</p>
            </div>
          </div>
          <a href="https://www.google.com/maps/search/?api=1&amp;query=Shanthala+Nagar,+Ashok+Nagar,+Bengaluru,+Karnataka+560025" target="_blank" rel="noopener noreferrer" class="footer-map-btn">
    ...
    <div class="container">
      <div class="footer-grid">
        ...
        <div class="footer-col">
          ...
          <ul>
            <li><a href="<?php echo $bp; ?>solutions/marketing/">Omnichannel Marketing</a></li>
            <li><a href="<?php echo $bp; ?>solutions/bulk-messaging/">Bulk Messaging</a></li>
        ...
        <div class="footer-col">
          ...
          <ul>
            ...
            <li><a href="https://www.google.com/maps/search/?api=1&amp;query=Shanthala+Nagar,+Ashok+Nagar,+Bengaluru,+Karnataka+560025" target="_blank" rel="noopener noreferrer" style="display:inline-flex;align-items:center;gap:4px;color:#A78BFA;font-weight:600">📍 Office Map ↗</a></li>
          </ul>
        </div>
      </div>
