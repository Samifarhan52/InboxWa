  ...
  <div class="container">
    <div class="section-header reveal" style="text-align:center">
      ...
      <div style="margin-top:1.5rem;display:flex;flex-wrap:wrap;gap:.75rem;justify-content:center">
        ...
        <a href="https://wa.me/<?php echo urlencode(cms_setting('support_whatsapp', '918050854445')); ?>" target="_blank" rel="noopener" class="btn btn-outline btn-lg" style="color:#fff;border-color:rgba(255,255,255,.35)">WhatsApp Us</a>
      </div>
    </div>
  </div>
</section>
