...
<head>
  ...
  <style id="hellobotz-navbar-style">
    /* ==========================================================================
       HelloBotz Global Header Navigation System (Matching GetGabs Master Reference)
    ...
    /* Primary CTA - GetGabs Deep Green Solid Pill Button */
    .header-btn-primary,
    .header-cta-start {
      display: inline-flex !important;
      align-items: center !important;
  ...
  <header class="site-header" role="banner">
    <div class="header-inner">
      ...
      <div class="header-actions">
        ...
        <a href="<?php echo $bp; ?>contact/" class="header-login header-btn-outline" onclick="if(window.openDemoModal){ window.openDemoModal(); return false; }">
    ...
    <div class="mobile-drawer">
      ...
      <div class="mobile-drawer-body">
        ...
        <div class="mobile-nav-actions">
          <a href="<?php echo $bp; ?>contact/" class="mnav-login" onclick="if(window.openDemoModal){ window.openDemoModal(); return false; }">Contact Sales &rarr;</a>
          <a href="<?php echo $bp; ?>auth/register" class="mnav-start" style="background:#044738 !important;border-color:#044738 !important;color:#ffffff !important;">Log in / Sign up &rarr;</a>
        </div>
      </div>
    </div>
  </div>
