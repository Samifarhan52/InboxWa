...
<body>
  ...
  <script>
    (function() {
      ...
      function playThemeTransition(nextTheme, originX, originY) {
        var btns = document.querySelectorAll('.theme-toggle-btn');
        btns.forEach(function(b) {
          b.classList.remove('btn-popping');
          void b.offsetWidth;
          b.classList.add('btn-popping');
          setTimeout(function() { b.classList.remove('btn-popping'); }, 500);
        });

        document.documentElement.classList.add('hb-theme-transitioning');
        setTimeout(function() {
          document.documentElement.classList.remove('hb-theme-transitioning');
        }, 450);

        if (typeof document.startViewTransition === 'function') {
          var x = originX || (window.innerWidth - 60);
          var y = originY || 35;
        ...
        // Atmospheric circular ripple fallback
        var wave = document.createElement('div');
        wave.className = 'hb-theme-wave wave-' + nextTheme;
        var wx = originX || (window.innerWidth - 60);
        var wy = originY || 35;
        var size = Math.max(window.innerWidth, window.innerHeight) * 2.4;
        wave.style.width = size + 'px';
        wave.style.height = size + 'px';
        wave.style.left = wx + 'px';
        wave.style.top = wy + 'px';
      ...
      function toggleTheme(e) {
        ...
        playThemeTransition(next, originX, originY);
      }
      ...
      function initTheme() {
        ...
        function onMobileToggle(e) {
          ...
          playThemeTransition(targetTheme, rect.left + rect.width / 2, rect.top + rect.height / 2);
        }
        ...
        document.addEventListener('click', function(e) {
          ...
          if (mobileOpt) {
            ...
            if (targetTheme) {
              var rect = mobileOpt.getBoundingClientRect();
              playThemeTransition(targetTheme, rect.left + rect.width / 2, rect.top + rect.height / 2);
            }
          }
        });
