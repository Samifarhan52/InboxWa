...
<head>
  ...
  <style id="hellobotz-floating-pill-navbar-style">
    ...
    body.dark-theme .site-header .header-inner {
      ...
      box-shadow: 0 16px 40px -4px rgba(0, 0, 0, 0.6), 0 4px 12px rgba(0, 0, 0, 0.35) !important;
    }
    ...
    body.dark-theme .site-header.scrolled .header-inner {
      ...
      box-shadow: 0 20px 48px -4px rgba(0, 0, 0, 0.75) !important;
    }
    @media (prefers-color-scheme: dark) {
      html:not([data-theme="light"]):not(.light-theme) .site-header .header-inner {
        background: rgba(15, 23, 42, 0.88) !important;
        border-color: rgba(255, 255, 255, 0.12) !important;
        box-shadow: 0 16px 40px -4px rgba(0, 0, 0, 0.6), 0 4px 12px rgba(0, 0, 0, 0.35) !important;
      }
      html:not([data-theme="light"]):not(.light-theme) .site-header.scrolled .header-inner {
        background: rgba(11, 15, 25, 0.94) !important;
        border-color: rgba(255, 255, 255, 0.18) !important;
        box-shadow: 0 20px 48px -4px rgba(0, 0, 0, 0.75) !important;
      }
    ...
    /* 1. TOP STATE (Light Mode): Sleek white pill with soft indigo glow */
    ...
    .site-header:not(.scrolled) .site-main-logo {
      ...
      box-shadow: 0 10px 28px -4px rgba(99, 102, 241, 0.16), 0 4px 12px rgba(15, 23, 42, 0.06) !important;
      background: rgba(255, 255, 255, 0.98) !important;
    }
    ...
    .site-header:not(.scrolled) .site-main-logo:hover {
      ...
      box-shadow: 0 14px 34px -4px rgba(99, 102, 241, 0.24), 0 6px 16px rgba(15, 23, 42, 0.1) !important;
    }

    /* 2. DOCKED STATE (Light Mode): Docked in header navbar */
    ...
    /* Dark Mode Logo Pill Overrides */
    html[data-theme="dark"] .site-header .logo,
    html[data-theme="dark"] .site-header .site-main-logo,
    body.dark-theme .site-header .logo,
    body.dark-theme .site-header .site-main-logo {
      background-color: #030712 !important;
      background-image: none !important;
    }
    html[data-theme="dark"] .site-header:not(.scrolled) .logo,
    html[data-theme="dark"] .site-header:not(.scrolled) .site-main-logo,
    body.dark-theme .site-header:not(.scrolled) .logo,
    body.dark-theme .site-header:not(.scrolled) .site-main-logo {
      border: 1px solid rgba(139, 92, 246, 0.6) !important;
      box-shadow: 0 12px 36px -4px rgba(139, 92, 246, 0.38), 0 4px 16px rgba(0, 0, 0, 0.45) !important;
      background-color: #030712 !important;
      background-image: radial-gradient(circle at 20% 50%, rgba(139, 92, 246, 0.22), transparent 70%) !important;
    }
    html[data-theme="dark"] .site-header:not(.scrolled) .logo:hover,
    html[data-theme="dark"] .site-header:not(.scrolled) .site-main-logo:hover,
    body.dark-theme .site-header:not(.scrolled) .logo:hover,
    body.dark-theme .site-header:not(.scrolled) .site-main-logo:hover {
    ...
    html[data-theme="dark"] .site-header.scrolled .site-main-logo,
    body.dark-theme .site-header.scrolled .logo,
    body.dark-theme .site-header.scrolled .site-main-logo {
      border: 1px solid rgba(99, 102, 241, 0.35) !important;
      box-shadow: 0 2px 8px rgba(3, 7, 18, 0.2) !important;
      background-color: #030712 !important;
      background-image: none !important;
    }
    html[data-theme="dark"] .site-header.scrolled .logo:hover,
    html[data-theme="dark"] .site-header.scrolled .site-main-logo:hover,
    body.dark-theme .site-header.scrolled .logo:hover,
    body.dark-theme .site-header.scrolled .site-main-logo:hover {
      border-color: rgba(99, 102, 241, 0.75) !important;
      box-shadow: 0 4px 16px rgba(99, 102, 241, 0.28) !important;
    }
    @media (prefers-color-scheme: dark) {
      html:not([data-theme="light"]):not(.light-theme) .site-header .logo,
      html:not([data-theme="light"]):not(.light-theme) .site-header .site-main-logo {
        background-color: #030712 !important;
        background-image: none !important;
      }
      html:not([data-theme="light"]):not(.light-theme) .site-header:not(.scrolled) .logo,
      html:not([data-theme="light"]):not(.light-theme) .site-header:not(.scrolled) .site-main-logo {
        border: 1px solid rgba(139, 92, 246, 0.6) !important;
        box-shadow: 0 12px 36px -4px rgba(139, 92, 246, 0.38), 0 4px 16px rgba(0, 0, 0, 0.45) !important;
        background-color: #030712 !important;
        background-image: radial-gradient(circle at 20% 50%, rgba(139, 92, 246, 0.22), transparent 70%) !important;
      }
      html:not([data-theme="light"]):not(.light-theme) .site-header.scrolled .logo,
      html:not([data-theme="light"]):not(.light-theme) .site-header.scrolled .site-main-logo {
        border: 1px solid rgba(99, 102, 241, 0.35) !important;
        box-shadow: 0 2px 8px rgba(3, 7, 18, 0.2) !important;
        background-color: #030712 !important;
        background-image: none !important;
    ...
    /* Logo Image Sizing & Light/Dark Mode Switching */
    ...
    @media (prefers-color-scheme: dark) {
      html:not([data-theme="light"]):not(.light-theme) .site-header .logo-img-light,
      html:not([data-theme="light"]):not(.light-theme) .mobile-drawer-header .logo-img-light {
        display: none !important;
      }
      html:not([data-theme="light"]):not(.light-theme) .site-header .logo-img-dark,
      html:not([data-theme="light"]):not(.light-theme) .mobile-drawer-header .logo-img-dark {
        display: block !important;
      }
    }
    ...
    html[data-theme="dark"] .mobile-drawer-header .logo,
    body.dark-theme .mobile-drawer-header .logo {
    ...
    @media (prefers-color-scheme: dark) {
      html:not([data-theme="light"]):not(.light-theme) .nav-link {
        color: #cbd5e1 !important;
      }
      html:not([data-theme="light"]):not(.light-theme) .nav-link:hover,
      html:not([data-theme="light"]):not(.light-theme) .nav-item:hover > .nav-link,
      html:not([data-theme="light"]):not(.light-theme) .nav-item.open > .nav-link {
        background: rgba(255, 255, 255, 0.08) !important;
        color: #ffffff !important;
      }
      html:not([data-theme="light"]):not(.light-theme) .nav-link-channels {
        color: #f8fafc !important;
      }
      html:not([data-theme="light"]):not(.light-theme) .nav-item-channels:hover > .nav-link-channels,
      html:not([data-theme="light"]):not(.light-theme) .nav-item-channels.open > .nav-link-channels {
        background: rgba(255, 255, 255, 0.12) !important;
        color: #ffffff !important;
      }
    }
    ...
    /* Dark theme text contrast for products mega menu */
    ...
    <div class="header-inner">
      <div class="logo-dock-wrapper" id="logo-dock-wrapper">
        <a href="<?php echo $bp; ?>" class="logo site-main-logo" id="site-logo" aria-label="<?php echo htmlspecialchars($SITE_NAME); ?> Home">
          <img src="<?php echo $bp; ?>assets/images/logo-light.png" alt="<?php echo htmlspecialchars($SITE_NAME); ?>" class="logo-img logo-img-light" width="130" height="40">
          <img src="<?php echo $bp; ?>assets/images/logo-dark.png" alt="<?php echo htmlspecialchars($SITE_NAME); ?>" class="logo-img logo-img-dark" width="130" height="40">
