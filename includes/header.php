...
<head>
  ...
  <style id="hellobotz-floating-pill-navbar-style">
    ...
    /* PRODUCTS MEGA MENU: Clean 5-Column SaaS Mega Menu Matching Reference */
    .mega-menu-products {
    ...
    .prodocu-chan-icon.wa {
      background: #25d366 !important;
      color: #ffffff !important;
    }

    .prodocu-chan-icon.ig {
    ...
    /* Middle 3 Columns: Marketing, Sales, Support */
    .prodocu-features-container {
      display: grid !important;
    ...
    .prodocu-integrate-more {
      margin-top: auto !important;
      padding-top: 10px !important;
      text-align: center !important;
    }

    .prodocu-integrate-more a {
    ...
    .prodocu-integrate-more a:hover {
            ...
            <div class="prodocu-mega-layout">
              ...
              <div class="prodocu-col-channels">
                ...
                <div class="prodocu-channel-list">
                  <button type="button" class="prodocu-channel-btn active" data-channel="whatsapp" title="WhatsApp Products">
                    <span class="prodocu-chan-icon wa">
                  ...
                  <button type="button" class="prodocu-channel-btn" data-channel="instagram" title="Instagram Products">
                    <span class="prodocu-chan-icon ig">
                ...
                <div class="prodocu-partner-badge">
                  <img src="<?php echo $bp; ?>assets/images/integrations/official-meta-partner.png" alt="Meta Official Partner" width="145" height="23">
                </div>
              </div>

              <!-- Columns 2, 3, 4: WHATSAPP Features Panel (Active by default) -->
              <div class="prodocu-features-container prodocu-panel-wa" id="prodocu-panel-whatsapp">
                <!-- Column 2: Marketing -->
                <div class="prodocu-feature-col">
                  ...
                  <div class="prodocu-items-list">
                    ...
                    <a href="<?php echo $bp; ?>products/ctwa/" class="prodocu-item" role="menuitem">
                      <div class="prodocu-item-icon">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"/><polygon points="12 8 16 12 12 12 12 16 12 8"/></svg>
                      </div>
                      <div class="prodocu-item-content">
                    ...
                    <a href="<?php echo $bp; ?>channel/whatsapp/" class="prodocu-item" role="menuitem">
                      <div class="prodocu-item-icon">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2l3.09 3.26 4.41.49 1.15 4.3 3.35 2.95-1.95 4.02.6 4.45-4.22 1.45-2.43 3.73L12 21.35l-4 1.3-2.43-3.73-4.22-1.45.6-4.45-1.95-4.02 3.35-2.95 1.15-4.3 4.41-.49L12 2z"/><polyline points="9 12 11 14 15 10"/></svg>
                      </div>
                      <div class="prodocu-item-content">
                ...
                <div class="prodocu-feature-col">
                  ...
                  <div class="prodocu-items-list">
                    ...
                    <a href="<?php echo $bp; ?>solutions/payments/" class="prodocu-item" role="menuitem">
                      <div class="prodocu-item-icon">
                ...
                <!-- Column 4: Support -->
                <div class="prodocu-feature-col no-border">
                  ...
                  <div class="prodocu-items-list">
                    ...
                    <a href="<?php echo $bp; ?>products/ai-agent/" class="prodocu-item" role="menuitem">
                      <div class="prodocu-item-icon">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2l2.4 6.9 6.9 2.4-6.9 2.4L12 20.6l-2.4-6.9-6.9-2.4 6.9-2.4L12 2z"/></svg>
                      </div>
                      <div class="prodocu-item-content">
              ...
              <!-- Columns 2, 3, 4: INSTAGRAM Features Panel (Toggleable) -->
              <div class="prodocu-features-container prodocu-panel-ig" id="prodocu-panel-instagram" style="display:none;">
                <!-- Column 2: Marketing (Instagram) -->
                <div class="prodocu-feature-col">
                  <div class="prodocu-section-title">Marketing</div>
                  <div class="prodocu-items-list">
                    ...
                    <a href="<?php echo $bp; ?>channel/instagram/" class="prodocu-item" role="menuitem">
                      <div class="prodocu-item-icon">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3l1.912 5.813a2 2 0 0 0 1.275 1.275L21 12l-5.813 1.912a2 2 0 0 0-1.275 1.275L12 21l-1.912-5.813a2 2 0 0 0-1.275-1.275L3 12l5.813-1.912a2 2 0 0 0 1.275-1.275L12 3z"/></svg>
                      </div>
                      <div class="prodocu-item-content">
              ...
              <div class="prodocu-col-integrate">
                <div class="prodocu-integrate-card">
                  <div class="prodocu-integrate-title">
                    <span>Integrate With</span>
                  </div>
                  <div class="prodocu-integrate-grid">
                    <a href="<?php echo $bp; ?>integrations/crm/" class="prodocu-int-tile" title="Zoho CRM">
                      <img src="<?php echo $bp; ?>assets/images/integrations/zoho.png" alt="Zoho" width="34" height="26">
                    </a>
                    <a href="<?php echo $bp; ?>integrations/google-sheets/" class="prodocu-int-tile" title="Google Sheets">
                      <img src="<?php echo $bp; ?>assets/images/integrations/google-sheet.png" alt="Google Sheets" width="34" height="26">
                    </a>
                    <a href="<?php echo $bp; ?>integrations/shopify/" class="prodocu-int-tile" title="Shopify">
                      <img src="<?php echo $bp; ?>assets/images/integrations/shopify.png" alt="Shopify" width="34" height="26">
                    </a>
                    <a href="<?php echo $bp; ?>integrations/woocommerce/" class="prodocu-int-tile" title="WooCommerce">
                      <img src="<?php echo $bp; ?>assets/images/integrations/woocommerce.png" alt="WooCommerce" width="34" height="26">
                    </a>
                    <a href="<?php echo $bp; ?>integrations/" class="prodocu-int-tile" title="Shiprocket">
                      <img src="<?php echo $bp; ?>assets/images/integrations/shiprocket.png" alt="Shiprocket" width="34" height="26">
                    </a>
                    <a href="<?php echo $bp; ?>integrations/" class="prodocu-int-tile" title="GoTab">
                      <img src="<?php echo $bp; ?>assets/images/integrations/gotab.png" alt="GoTab" width="34" height="26">
                    </a>
                    <a href="<?php echo $bp; ?>integrations/" class="prodocu-int-tile" title="Wortal">
                      <img src="<?php echo $bp; ?>assets/images/integrations/wortal.png" alt="Wortal" width="34" height="26">
                    </a>
                    <a href="<?php echo $bp; ?>integrations/" class="prodocu-int-tile prodocu-int-arrow" title="View All Integrations">
                      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg>
                    </a>
                  </div>
                  <div class="prodocu-integrate-more">
                    <a href="<?php echo $bp; ?>integrations/">All 50+ Apps &rarr;</a>
                  </div>
                </div>
              </div>
            </div>
          ...
          <script>
            (function() {
              function setupProdocuMega() {
                ...
                var waPanel = document.getElementById('prodocu-panel-whatsapp');
                var igPanel = document.getElementById('prodocu-panel-instagram');
                if (!buttons.length || !waPanel || !igPanel) return;
      ...
      <div class="mobile-drawer-body">
        <div class="mobile-nav-item" data-accordion>
          ...
          <div class="mobile-submenu"><div class="mobile-submenu-inner">
            <a href="<?php echo $bp; ?>products/broadcast/">Broadcast (Bulk Messaging)</a>
            <a href="<?php echo $bp; ?>products/ctwa/">Click-to-WhatsApp Ads (CTWA)</a>
            <a href="<?php echo $bp; ?>products/automation/">Drip Campaigns &amp; Flows</a>
            <a href="<?php echo $bp; ?>products/catalog/">Catalog Showcase</a>
            <a href="<?php echo $bp; ?>products/whatsapp-form/">WhatsApp Forms &amp; Flows</a>
            <a href="<?php echo $bp; ?>products/chatbot/">AI Chatbot &amp; Sales Bot</a>
            <a href="<?php echo $bp; ?>solutions/payments/">WhatsApp Payments</a>
            <a href="<?php echo $bp; ?>products/shared-inbox/">Shared Team Inbox</a>
            <a href="<?php echo $bp; ?>products/analytics/">Analytics Dashboard</a>
            <a href="<?php echo $bp; ?>integrations/">Integrations (Zoho, Shopify, Sheets)</a>
          </div></div>
        </div>
        <div class="mobile-nav-item" data-accordion>
