...
<head>
  ...
  <style id="hellobotz-floating-pill-navbar-style">
    ...
    .header-inner {
      ...
      box-shadow: 0 10px 30px -5px rgba(15, 23, 42, 0.08), 0 4px 12px rgba(15, 23, 42, 0.03) !important;
      box-sizing: border-box !important;
    ...
    .site-header.scrolled .header-inner {
      ...
      box-shadow: 0 14px 36px -4px rgba(15, 23, 42, 0.14), 0 4px 12px rgba(15, 23, 42, 0.06) !important;
    ...
    /* Logo Container - Integrated in Same Bar */
    .logo-dock-wrapper {
    ...
    /* Logo Image Sizing & Smooth Resizing on Scroll */
    .site-header .logo-img {
      ...
      transition: height 0.3s cubic-bezier(0.16, 1, 0.3, 1),
                  max-width 0.3s cubic-bezier(0.16, 1, 0.3, 1) !important;
    }
