...
$waWidgetSalesMail = cms_setting('sales_email', 'mail@hellobotz.com');
...
<div class="hellobotz-robot-widget wa-widget" id="hellobotz-robot-widget">
  ...
  <div class="hellobotz-chatbox wa-widget-panel" role="dialog" aria-label="HelloBotz AI Assistant">
    ...
    <div class="hellobotz-chat-header">
      <div class="hellobotz-chat-header-robot">
        ...
        <div class="header-robot-info">
          ...
          <p>HelloBotz 24/7 Official Assistant</p>
        </div>
      </div>
    ...
    <div class="hellobotz-quick-channels" aria-label="Direct contact options">
      <!-- WhatsApp Direct -->
      <a href="https://wa.me/<?php echo urlencode($waWidgetNum); ?>?text=Hi%20HelloBotz%2C%20I%20am%20interested%20in%20HelloBotz%20WhatsApp%20Automation." target="_blank" rel="noopener" class="quick-channel-item qc-wa" title="Open WhatsApp Chat">
      ...
      <!-- Download / Get Data -->
      <a href="https://panindiadata.com/" target="_blank" rel="noopener noreferrer" class="quick-channel-item qc-data" title="Download Verified B2B Datasets (PanIndiaData.com)">
    ...
    <div class="hellobotz-chat-body" role="log" aria-live="polite">
      <!-- Dynamic messages injected by robot-chatbot.js -->
    </div>

    <!-- CHAT INPUT FOOTER -->
    <div class="hellobotz-chat-footer">
      <form class="hellobotz-chat-form" action="javascript:void(0);">
        <input type="text" class="hellobotz-chat-input" placeholder="Ask HelloBotz about WhatsApp API, Pricing..." autocomplete="off" aria-label="Ask HelloBotz a question">
        <button type="submit" class="hellobotz-chat-submit" aria-label="Send question">
          <svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
      ...
      <div class="hellobotz-chat-trust">
        <span>⚡ Powered by HelloBotz &bull; HelloBotz Official Meta Cloud API</span>
      </div>
    </div>
  </div>
